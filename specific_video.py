...
def get_video_title_and_description(video_id):
    ...
    return snippet["title"], snippet.get("description", "")
...
def is_top_x_video(ai_response):
    return ai_response and "This is not a Top X video" not in ai_response
...
if __name__ == "__main__":
    ...
    try:
        ...
        video_title, video_description = get_video_title_and_description(video_id)
        ...
        if transcript:
            ...
            ai_response = send_to_openai(video_id, video_title, transcript, video_description)
            ...
            if ai_response:
                ...
                if is_top_x_video(ai_response):
                    ...
                    # ✅ Format comment text
                    comment_text = "📋 Here's the timestamps:\n\n"
